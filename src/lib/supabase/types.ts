...
//     WITH CHECK: true
//   Policy "auth_delete_certificados" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: true
...
//     WITH CHECK: true
//   Policy "auth_delete_erp" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "auth_read_erp" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: leads_parceiros
//   Policy "anon_insert_parceiros" (INSERT, PERMISSIVE) roles={anon,authenticated}
//     WITH CHECK: true
//   Policy "auth_delete_parceiros" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "auth_read_parceiros" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: logs_auditoria
